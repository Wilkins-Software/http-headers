...
export class CacheControlHeader extends BaseHeader {
  ...
  protected _noCache: boolean = false;
  ...
  protected _mustUnderstand: boolean = false;
  ...
  protected _staleIfError: boolean = false;
